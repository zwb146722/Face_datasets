...
def run_demo(cfg, frame_provider):
    """
    Run demo visualization. 运行可视化演示
    Args:
    ...
    """
    # Set random seed from configs. 从配置文件设置随机种子
...
def demo(cfg):
    ...
    if cfg.DETECTION.ENABLE and cfg.DEMO.PREDS_BOXES != "":
        ...
        for task in tqdm.tqdm(run_demo(cfg, frame_provider)):  #tqdm.tqdm实现进度条
